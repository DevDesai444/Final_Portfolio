...
var PostHogPersistence = /** @class */ (function () {
    ...
    PostHogPersistence.prototype.update_campaign_params = function () {
        if (!this.campaign_params_saved) {
            var campaignParams = getCampaignParams(this._config.custom_campaign_params, this._config.mask_personal_data_properties, this._config.custom_personal_data_properties);
    ...
    PostHogPersistence.prototype.set_initial_person_info = function () {
        ...
        this.register_once((_a = {},
            _a[INITIAL_PERSON_INFO] = getPersonInfo(this._config.mask_personal_data_properties, this._config.custom_personal_data_properties),
            _a), undefined);
    };
    ...
    PostHogPersistence.prototype.get_initial_props = function () {
        ...
        if (initialPersonInfo) {
            var initialPersonProps = getInitialPersonPropsFromInfo(initialPersonInfo);
