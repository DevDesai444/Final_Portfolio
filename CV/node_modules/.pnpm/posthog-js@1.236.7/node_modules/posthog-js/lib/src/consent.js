...
var ConsentManager = /** @class */ (function () {
    ...
    ConsentManager.prototype.optInOut = function (isOptedIn) {
        this._storage.set(this._storageKey, isOptedIn ? 1 : 0, this._config.cookie_expiration, this._config.cross_subdomain_cookie, this._config.secure_cookie);
    };
    ...
    Object.defineProperty(ConsentManager.prototype, "_storedConsent", {
        get: function () {
            var value = this._storage.get(this._storageKey);
