...
export declare const SURVEY_DEFAULT_Z_INDEX = 2147483647;
...
export declare const createShadow: (styleSheet: string, surveyId: string, element?: Element, posthog?: PostHog) => ShadowRoot;
...
export declare const canActivateRepeatedly: (survey: Pick<Survey, "schedule" | "conditions">) => boolean;
/**
...
export declare const hasWaitPeriodPassed: (lastSeenSurveyDate: string | null, waitPeriodInDays: number | undefined) => boolean;
