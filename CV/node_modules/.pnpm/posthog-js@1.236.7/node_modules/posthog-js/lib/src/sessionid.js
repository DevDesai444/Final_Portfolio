...
var logger = createLogger('[SessionId]');
export var DEFAULT_SESSION_IDLE_TIMEOUT_SECONDS = 30 * 60; // 30 minutes
export var MAX_SESSION_IDLE_TIMEOUT_SECONDS = 10 * 60 * 60; // 10 hours
...
var SessionIdManager = /** @class */ (function () {
    function SessionIdManager(instance, sessionIdGenerator, windowIdGenerator) {
        ...
        var desiredTimeout = this._config['session_idle_timeout_seconds'] || DEFAULT_SESSION_IDLE_TIMEOUT_SECONDS;
        ...
        if ((_a = this._config.bootstrap) === null || _a === void 0 ? void 0 : _a.sessionID) {
            try {
                var sessionStartTimestamp = uuid7ToTimestampMs(this._config.bootstrap.sessionID);
    ...
    SessionIdManager.prototype._getSessionId = function () {
        ...
        var sessionIdInfo = this._persistence.props[SESSION_ID];
